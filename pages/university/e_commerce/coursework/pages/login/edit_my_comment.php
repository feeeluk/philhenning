<?php
	...
	if(isset($_SESSION['e_commerce_username']))
	{
		...
		{
			$delete_query = "DELETE FROM ecom_post WHERE id = $post_id";
		...
		if(isset($_GET['submit']))
		{
			...
			$update_query = "UPDATE ecom_post SET comment = '$updated_comment' WHERE id = $post_id";
		...
		{
			// create post query
			$query = "SELECT * FROM ecom_post WHERE id = '$post_id'";
