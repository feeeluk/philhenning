<?php
	...
	if(isset($_SESSION['web_development_username']))
	{
		...
		{
			$delete_query = "DELETE FROM wd_post WHERE id = $post_id";
		...
		if(isset($_GET['submit']))
		{
			...
			$update_query = "UPDATE wd_post SET comment = '$updated_comment' WHERE id = $post_id";
		...
		{
			// create post query
			$query = "SELECT * FROM wd_post WHERE id = '$post_id'";
