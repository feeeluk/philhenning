...
DROP TABLE IF EXISTS `wd_manufacturer`;
DROP TABLE IF EXISTS `wd_type`;
DROP TABLE IF EXISTS `wd_product`;
DROP TABLE IF EXISTS `wd_product_image`;
DROP TABLE IF EXISTS `wd_post`;
...
INSERT INTO `wd_user` (`username`, `email`, `password`, `title`, `first_name`, `last_name`, `gender`, `dob`, `image`, `joined`, `is_admin`)
VALUES
...
INSERT INTO `wd_manufacturer` (`id`, `manufacturer`, `year_established`, `headquarters`, `website`, `image`, `about`)
VALUES
...
INSERT INTO `wd_type` (`id`, `name`, `description`)
VALUES
...
CREATE TABLE `wd_product` (
  ...
  `description` TEXT,
  PRIMARY KEY (`id`),
  FOREIGN KEY (`manufacturer_id`) REFERENCES `wd_manufacturer` (`id`),
  FOREIGN KEY (`type_id`) REFERENCES `wd_type` (`id`),
  UNIQUE (`name`)
);

INSERT INTO `wd_product` (`id`, `name`, `manufacturer_id`, `type_id`, `price`, `year`, `description`)
VALUES
...
PRIMARY KEY (`id`),
FOREIGN KEY (`username`) REFERENCES `wd_user` (`username`),
FOREIGN KEY (`product_id`) REFERENCES `wd_product` (`id`),
FOREIGN KEY (`manufacturer_id`) REFERENCES `wd_manufacturer` (`id`)
);

INSERT INTO `wd_post` (`id`, `username`, `product_id`, `manufacturer_id`, `post_time`, `comment`)
VALUES
...
INSERT INTO `wd_product_image` (`product_id`, `location`)
VALUES
