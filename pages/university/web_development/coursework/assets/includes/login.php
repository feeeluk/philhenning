					...
					<aside>
						...
						<div class="aside_layout">
							...
							<form name="login" id="login" method="post" action="<?php echo $path; ?>pages/login/set_session.php">
								...
								if(isset($_SESSION['web_development_message']))
									{
										echo "<p class='message'>". $_SESSION['web_development_message']."</p>";
									}
								?>
						</div>	
						...
						<div class="aside_layout">
								...
								<?php
									echo "<h3>".$_SESSION['web_development_username']."</h3>
										<ul>
									...
									$query =  "SELECT is_admin FROM wd_user WHERE username = '".$_SESSION['web_development_username']."'";
